...
@Setter
@Entity
public class Decor extends BaseEntityForSaleByParentWeight {

    @ManyToMany
    @JoinTable(name = "cake_decor",
            joinColumns = { @JoinColumn(name = "cake_pid", referencedColumnName = "pid") },
            inverseJoinColumns = { @JoinColumn(name = "decor_pid", referencedColumnName = "pid")})
